...
(use-package centaur-tabs
  ...
  ;; Mouse support - middle click to close buffer
  (defun centaur-tabs-buffer-close-on-middle-click (event)
    "Close buffer on middle mouse click."
    (interactive "e")
    (let* ((click-pos (event-start event))
           (window (posn-window click-pos))
  ...
  (when (display-graphic-p)
    ...
    (global-set-key [header-line mouse-2] #'centaur-tabs-buffer-close-on-middle-click)
    ;; Left click to switch tab
    (global-set-key [header-line mouse-1] #'centaur-tabs-do-select)
    ;; Mouse wheel scrolling through tabs
    (global-set-key [header-line wheel-up] #'centaur-tabs-backward)
    (global-set-key [header-line wheel-down] #'centaur-tabs-forward))
  ...
  (("C-<prior>" . centaur-tabs-backward)
   ...
   ("s-t" . centaur-tabs-counsel-switch-group)
