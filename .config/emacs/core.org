#+TITLE: Emacs Core Settings
#+AUTHOR: Jesse Bellingham
#+DESCRIPTION: Core Emacs settings and behavior modifications
#+PROPERTY: header-args:emacs-lisp :tangle modules/core.el :comments org
#+AUTO_TANGLE: t
