#+TITLE: Emacs File Explorer & Project Dashboard
#+AUTHOR: Jesse Bellingham
#+DESCRIPTION: File tree management with treemacs and startup dashboard
#+PROPERTY: header-args:emacs-lisp :tangle modules/explorer.el :comments org
#+AUTO_TANGLE: t
